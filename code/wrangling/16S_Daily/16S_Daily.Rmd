...
```{r}
path <- "/Users/nathangreenslit/Desktop/UGA/Lipp Lab/Sequencing/data/raw_data/16S_Daily" # CHANGE ME to the directory containing the fastq files after unzipping.
list.files(path)
```
